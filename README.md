...
```bash
rails new [MyAppName] -m https://github.com/leschenko/ab_admin/blob/rails4/lib/generators/template.rb
```

Or add gems from template [list of gems](https://github.com/leschenko/ab_admin/blob/rails4/lib/generators/template.rb) to an existing application and run generators:
